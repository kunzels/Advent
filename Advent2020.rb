...
#     height = former.length
#     width = former[0].length
#     doit = true
...
#                     next
#                 elsif seat == "L" || seat == "#"
#                     seats = seatMap(former, idx, idx2, height, width)
#                     # square = [
#                     #     former[idx - 1][idx2 - 1], 
#                     #     former[idx - 1][idx2], 
#                     #     former[idx -1][idx2 + 1], 
...
# def seatMap(former, idx, idx2, height, width)
#     seats = []
#     row = idx - 1
#     col = idx2
